...
namespace JFrog.Artifactory.Utils
{
	...
	public class ArtifactoryBuildInfoClient
    {
		...
		private IBuildInfoLog _log;

		public ArtifactoryBuildInfoClient(string artifactoryUrl) {
			initialize(artifactoryUrl, null, null, null);
		}

		public ArtifactoryBuildInfoClient(string artifactoryUrl, string username, string password, IBuildInfoLog log)
		{
			initialize(artifactoryUrl, username, password, log);
		}

		private void initialize(string artifactoryUrl, string username, string password, IBuildInfoLog log)
        {
